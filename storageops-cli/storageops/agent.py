"""
StorageOps Agent — deterministic offline diagnostic orchestrator.

Runs rule-based parsers and analyzers from storageops-core.
For LLM-powered diagnosis use: storageops agent <file>  (requires Pi Coding Agent).
"""
...
def agent_run(initial_file: str = None, interactive: bool = False) -> int:
    """Run the offline rule-based diagnostic loop. Returns exit code."""
